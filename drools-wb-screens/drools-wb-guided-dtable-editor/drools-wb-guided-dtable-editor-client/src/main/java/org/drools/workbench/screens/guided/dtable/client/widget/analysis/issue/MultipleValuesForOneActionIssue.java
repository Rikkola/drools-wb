...
public class MultipleValuesForOneActionIssue extends Issue {
    ...
    public MultipleValuesForOneActionIssue( DetectMultipleValuesForOneActionCheck check ) {
        ...
        getExplanation()
                .startNote()
                .addParagraph( AnalysisConstants.INSTANCE.MultipleValuesNote1P1( check.getConflictingObjects().get( 0 ).toHumanReadableString(), check.getConflictingObjects().get( 1 ).toHumanReadableString() ) )
                .end()
