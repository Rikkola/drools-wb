...
public class ActionInspectorConflictTest {
    ...
    private ActionInspector createSetActionInspector( String boundName,
                                                      String factField,
                                                      DTCellValue52 cell ) {
        return new ActionInspector( mock( AnalysisDecisionTableUtils.class ),
                                    new FactFieldColumnActionInspectorKey( createActionSetFieldCol( boundName,
                                                                                                factField ) ),
                                    cell ) {
            @Override
    ...
    private ActionInspector createSetActionInspector( String stringValue,
        ...
        return new ActionInspector( mock( AnalysisDecisionTableUtils.class ),
                                    new FactFieldColumnActionInspectorKey( actionCol ),
